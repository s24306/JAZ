...
import main.java.org.example.rules.NotNullValidationRule;
import main.java.org.example.rules.RangeValidationRule;
import main.java.org.example.rules.RegexValidationRule;
import main.java.org.example.validation.ValidationResult;
import main.java.org.example.validation.Validator;
...
public class Main {
    ...
    private static void createValidationRuleForRegexAnnotation() throws Exception {
        ...
        /**
         * Dodaj trzecią implemenatcję interfejsu ICheckValidationRule dla adnotacji Regex
         *
         */
