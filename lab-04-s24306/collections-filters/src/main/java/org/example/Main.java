...
import main.java.org.example.model.Gender;
import main.java.org.example.model.PeopleSample;
import main.java.org.example.model.Person;
import main.java.org.example.queries.QueryProcessor;
import main.java.org.example.queries.filters.*;
import main.java.org.example.queries.results.Results;
import main.java.org.example.queries.search.Funcs;
import main.java.org.example.queries.search.FunctionsParameters;
import main.java.org.example.queries.search.Page;
...
public class Main {
    public static void main(String[] args){
         ...
         * -> canFilter - metoda która spawdza czy dany filtr będzie teraz wykorzystany
         * -> filter - metoda która zwróci nową kolekcję
         */
...
//                .addCalculation(ageCalculator);
        ...
        /**
         * Ostatnim krokiem do zakończenia zadania jest
